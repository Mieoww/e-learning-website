...
<style>
    ...
    .services 
    {
        ...
        input[type=text], input[type=submit], input[type=email], input[type=number], input[type=date], input[type=file]{
            width: 50%;
...
<section id="services" class="services">
      <div class="container" align=center>
        ...
        <div align=center>
            <a class="cta-btn" href="/projetinfo253/views/module/listeModule.php" >Revenir a la liste</a>
        </div>
      </div>
